...
from supabase_mcp.core.mcp_server import create_mcp_server
...
# async def call_auth_admin_method(container: Container, method: str, params: dict[str, Any]) -> dict[str, Any]:
...
def run_server() -> None:
    ...
    # Register tools
    mcp_with_tools = ToolRegistry(mcp=mcp, services_container=services_container).register_tools()
