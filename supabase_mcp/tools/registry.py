...
class ToolRegistry:
    ...
    def register_tools(self, server=None) -> FastMCP:
        ...
        if ToolName.GET_SCHEMAS not in exclude_tools:
            ...
            async def get_schemas() -> QueryResult:
                ...
                return await feature_manager.execute_tool(
                    ToolName.GET_SCHEMAS, services_container=services_container
                )
        ...
        if ToolName.RETRIEVE_MIGRATIONS not in exclude_tools:
        ...
        if ToolName.SEND_MANAGEMENT_API_REQUEST not in exclude_tools:
        ...
        if ToolName.GET_MANAGEMENT_API_SPEC not in exclude_tools:
        ...
        if ToolName.GET_AUTH_ADMIN_METHODS_SPEC not in exclude_tools:
        ...
        if ToolName.CALL_AUTH_ADMIN_METHOD not in exclude_tools:
        ...
        if ToolName.LIVE_DANGEROUSLY not in exclude_tools:
        ...
        if ToolName.CONFIRM_DESTRUCTIVE_OPERATION not in exclude_tools:
        ...
        if ToolName.RETRIEVE_LOGS not in exclude_tools:
