...
class TestApiSpecManager:
    ...
    # Local Spec Tests
    def test_load_local_spec_success(self, spec_manager):
    ...
    def test_load_local_spec_file_not_found(self, spec_manager):
    ...
    def test_load_local_spec_invalid_json(self, spec_manager):
    ...
    # Remote Spec Tests
    @pytest.mark.asyncio
    async def test_fetch_remote_spec_success(self, spec_manager):
    ...
    @pytest.mark.asyncio
    async def test_fetch_remote_spec_api_error(self, spec_manager):
    ...
    @pytest.mark.asyncio
    async def test_fetch_remote_spec_network_error(self, spec_manager):
    ...
    # Startup Flow Tests
    @pytest.mark.asyncio
    async def test_startup_remote_success(self, spec_manager):
    ...
    @pytest.mark.asyncio
    async def test_startup_remote_fail_local_fallback(self, spec_manager):
    ...
    @pytest.mark.asyncio
    async def test_startup_both_fail(self, spec_manager):
    ...
    # Get Spec Tests
    def test_get_spec_success(self, spec_manager):
        """Test getting loaded spec"""
        spec_manager.spec = SAMPLE_SPEC
        result = spec_manager.get_spec()
        assert result == SAMPLE_SPEC

    def test_get_spec_not_loaded(self, spec_manager):
